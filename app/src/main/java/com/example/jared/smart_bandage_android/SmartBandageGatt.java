...
public class SmartBandageGatt {
    public final static UUID
        ...
        UUID_EXTRA_PTR              = fromString("0000f0fd-0000-1000-8000-00805f9b34fb"),
        UUID_EXTRA_DATA             = fromString("0000f0fe-0000-1000-8000-00805f9b34fb");

    public enum EXTRA_PTR_VALUES {
        CheckSleepIntervalMS,
        BLECheckInterval,
        CheckReadDelayMS,
        MaxTransmitStateTimeS,
    }
}